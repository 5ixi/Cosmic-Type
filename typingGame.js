const quotes = [
  ...
  function updateTimer() {
    ...
    // Update WPM if typing has started
  ...
  function displayQuote(quote) {
    ...
    // Create a span for each character for styling
  ...
  function checkInput() {
    ...
    quoteArray.forEach((charSpan, index) => {
      ...
      if (inputChar == null) {
        ...
        // Count first-time mistakes only
    ...
    if (inputArray.length === quoteArray.length && allCorrect) {
      finishGame();
    }
  }
